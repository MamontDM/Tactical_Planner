...
import { curveEndDrawArrow , drawSmoothCurve, drawArea } from '../utils/canvasHelpers';
...
export const drawObject = (canvas, object) => {
    ...
    switch (object.type){
        ...
        case 'radar':
            ...
            break;
        case 'vision':
            const startPointX = object.points ? object.points[0].x : object.x;
            const startPointY = object.points ? object.points[0].y : object.y;
