export const getSvgTemplate = (type, color) => {
    const templates = {
        ...
        `<svg id="uuid-9807c151-86f7-4689-abee-aecc1c73db6b" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 335.5 155">
            ...
            <polygon class="uuid-c5ace427-beea-4f5c-98a0-99f3e87ccc72" points="218.95 .81 136.77 154.5 253.67 154.4 335.5 77.46 253.41 .81 218.95 .81"/>
        </g>
        <g id="uuid-4a547b8c-0182-4630-ad57-358bdd773360" data-name="Слой 2">
            <polygon class="uuid-d15842ec-0213-4902-9dab-669588492087" points="161.05 .9 1.33 .5 .5 154.5 74.08 154.5 161.05 .9"/>
        </g>
        <polygon class="uuid-2748157d-0314-4e38-9e96-d122906c31c5" points="246.01 27.04 261.21 58.17 295.19 63.16 270.6 87.39 276.4 121.6 246.01 105.45 215.61 121.6 221.42 87.39 196.83 63.16 230.81 58.17 246.01 27.04"/>
        <polygon class="uuid-2748157d-0314-4e38-9e96-d122906c31c5" points="54.27 27.04 69.47 58.17 103.45 63.16 78.86 87.39 84.67 121.6 54.27 105.45 23.88 121.6 29.68 87.39 5.09 63.16 39.07 58.17 54.27 27.04"/>
        </svg>
        `,
        Battleship: 
