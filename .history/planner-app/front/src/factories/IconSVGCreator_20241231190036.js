    ...
    const templates = {
        ...
        Cruiser:
            `<svg id="uuid-9807c151-86f7-4689-abee-aecc1c73db6b" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 335.5 155">
                    ...
                    <polygon fill="#ffffff" class="uuid-2748157d-0314-4e38-9e96-d122906c31c5" points="246.01 27.04 261.21 58.17 295.19 63.16 270.6 87.39 276.4 121.6 246.01 105.45 215.61 121.6 221.42 87.39 196.83 63.16 230.81 58.17 246.01 27.04"/>
                    <polygon fill="#ffffff" class="uuid-2748157d-0314-4e38-9e96-d122906c31c5" points="54.27 27.04 69.47 58.17 103.45 63.16 78.86 87.39 84.67 121.6 54.27 105.45 23.88 121.6 29.68 87.39 5.09 63.16 39.07 58.17 54.27 27.04"/>
                </svg>`,
        Battleship: 
