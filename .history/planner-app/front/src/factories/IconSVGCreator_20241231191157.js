export const getSvgTemplate = (type, color) => {
    const templates = {
        ...
        `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 250 150" width="250" height="150">
            ...
            <polygon fill="#000000" transform="translate(10, -10)" transform="rotate(15)" points="54.27 27.04 69.47 58.17 103.45 63.16 78.86 87.39 84.67 121.6 54.27 105.45 23.88 121.6 29.68 87.39 5.09 63.16 39.07 58.17 54.27 27.04" />
</svg>
        `,
        Cruiser:
