    ...
    const templates = {
        ...
        SuperBattleship: 
            ...
            `<svg id="uuid-7dd4bd05-ecf2-425d-8ebe-d6a307636daf" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340.48 151.81">
                <rect stroke=${color} class="uuid-c8645f5e-1211-460d-aa79-a6bfeaa0fff5" x=".5" y="1.2" width="241.65" height="67.75"/>
                <rect stroke=${color} class="uuid-39ea2ef7-88a3-41ae-a51d-bf6631802274" x=".5" y="81.84" width="241.65" height="68.78"/>
            ...
            <defs>
                <style>
                .uuid-24fd16f4-33de-4acf-a285-8f404cc9b68a {
                    stroke: #0a0a0a;
                    stroke-miterlimit: 10;
                }
                </style>
            </defs>
                <rect class="uuid-24fd16f4-33de-4acf-a285-8f404cc9b68a" x=".5" y=".5" width="15.85" height="149.42"/>
                <polygon class="uuid-24fd16f4-33de-4acf-a285-8f404cc9b68a" points="335.93 75.3 27.68 .68 27.68 149.92 335.93 75.3"/>
            </svg>`, 
    };
