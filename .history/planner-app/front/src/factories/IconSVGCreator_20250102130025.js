export const getSvgTemplate = (type, color) => {
    const templates = {
        ...
        SuperBattleship: 
            ...
            Submarine: 
            `<svg id="uuid-a311300f-8123-4bed-afab-a88312d84611" data-name="uuid-07a49578-6cba-4792-aa0b-7a927e8c0676" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 334.27 143.54">
                <rect fill="${color}" class="uuid-c3ad4a83-7935-487a-a6bc-ff646ab17cb0" x=".5" y=".64" width="34.17" height="142.25"/>
                <polygon fill="${color}" class="uuid-c3ad4a83-7935-487a-a6bc-ff646ab17cb0" points="332.26 71.77 55.67 .64 55.67 142.9 332.26 71.77"/>
            </svg>`, 
    };
