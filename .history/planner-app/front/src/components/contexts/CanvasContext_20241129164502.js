...
export const CanvasProvider = ({ children }) => {
    ...
    const defaultBackground = (backgroundCanvas) =>{
        backgroundCanvas.style.backgroundImage = `url(${BgCanvas})`;
    ...
    useEffect(() => {
        ...
        if(backgroundCanvas){
            defaultBackground(backgroundCanvas);
        }
    }, [background]);
    ...
    const clearBackground = () => setBackground(defaultBackground(backgroundCanvas.current));
