...
const IconTool = ({isActive}) =>{ 
    ...
    const [shipIcon, setSelectShipIcon] = useState(null);
        ...
        return ReactDOM.createPortal(
            <div className="tool-settings">
                ...
                <ul className="ship-icon-list">
                    ...
                    >
                        <img className="shipIcon-img" scr={icons.destroyer} alt="destroyer IMG" />
                    </button>
                    <button className="ship-button">
                        <img className="shipIcon-img" scr={icons.cruiser}></img>
                    </button>
                    <button className="ship-button">
                        <img className="shipIcon-img" scr={icons.battleship}></img>
                    </button>
                </ul>
            </div>
            , 
            document.getElementById('right-sidebar-settings')
    );
};
