...
import ShipListCard from '../../../../LeftSidebar/PlannerHelper/components/ShipList/ShipsCard/ShipListCard';
    ...
    const renderSettings = () => {
        if(settingSource === "manual"){
            ...
            return (
                <>
                    <h3>From list</h3>
                    <div className="ship-list-setting">
                        {selectedShip.map((ship) => (
                            <ShipListCard key={ship.id} ship={[ship]} viewType='button' />
                        ))}
                    </div>
                </>
            );
