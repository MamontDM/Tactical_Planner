...
const RadarTool = ({ isActive, commonSettings, onChangeCommonSettings }) => {
    ...
    }, [isActive, canvasRef, drawingCanvasRef, objects, canvasRef, drawingCanvasRef, getCanvasContext, getDrawingCanvasContext, clearDrawingCanvas, dispatch, strokeStyle]);
