...
const IconTool = ({isActive}) =>{ 
    ...
    useEffect((isActive) => {
        ...
        if (isActive && canvasRef?.current && drawingCanvasRef?.current) {
            ...
            const handleMouseMove = (event) => {
                ...
                drawTemporaryIcon(drawingCtx, { x, y, key: shipImg.current, color: fillColor.current, label: shipLabel.current });
            };
    ...
    },[isActive, canvasRef, dispatch, shipImg,
            ...
            <div className="tool-settings">
                ...
                <ul className="ship-icon-list">
                   ...
                   <img className="ship-icon" src={IconDestroyer} alt="error" />
                    ...
                    <div>
                    <img src={shipImg.current} alt="Generated Icon" />
                    </div>
                </ul>
                <h3>Set Color:</h3>
