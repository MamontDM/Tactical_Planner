    ...
    const icons = {
        ...
        cruiser: (
            <svg id="uuid-e9367c4c-95b3-4e39-b056-31b48712996f" data-name="Слой 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 346.67 154">
                <polygon fill={fillColor.current} stroke-width="0px" class="uuid-92066642-a0e2-4372-8c77-4df0d47e7d85" points="0 153.51 41.79 153.94 135.83 .43 .87 0 0 153.51"/>
                <polygon fill={fillColor.current} stroke-width="0px" class="uuid-92066642-a0e2-4372-8c77-4df0d47e7d85" points="134.37 .36 173.82 .36 79.62 153.94 40.17 153.94 134.37 .36"/>
                <polygon fill={fillColor.current} stroke-width="0px" class="uuid-92066642-a0e2-4372-8c77-4df0d47e7d85" points="252.3 .3 346.67 77.15 252.88 154 158.51 154 252.3 .3"/>
                <polygon fill={fillColor.current} stroke-width="0px" class="uuid-92066642-a0e2-4372-8c77-4df0d47e7d85" points="213.39 .42 252.84 .42 158.64 153.99 119.19 153.99 213.39 .42"/>
            </svg>
        ),
        destroyer: (
