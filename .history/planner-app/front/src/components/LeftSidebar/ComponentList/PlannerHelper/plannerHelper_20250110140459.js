...
const PlannerHelper = () =>{
    ...
    const shipTypes =  [
        {id: 1, label: 'Battleships', icon: IconBattleship, title: 'Battleship' },
        {id: 2, label: 'Cruisers',    icon: IconCruiser, title: 'Cruiser' }, 
        {id: 3, label: 'Destroyers' , icon: IconDestroyer, title: 'Destoyer'},
        {id: 4, label: 'Submarines',  icon: IconSubmarine, title: 'Sub Marine'},
        {id: 5, label: 'AirCarriers', icon: IconAircraft_carrier, title: 'Carrier'},
    ];
            ...
            <div className="planner-wrapper">
                <div className="planner-sidebar">
                    ...
                    <div className="config-summary">
                            <h3>Ship limitations by Type</h3>
                        <ConfigList />
                        <ShipTemplate />
                        </div>
                    )}
