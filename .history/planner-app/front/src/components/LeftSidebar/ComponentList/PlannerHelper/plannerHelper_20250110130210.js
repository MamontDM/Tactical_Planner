...
const PlannerHelper = () =>{
    ...
    const shipTypes =  [
        {id: 1, label: 'Posible of super ships',  icon: IconSuper_ship, title: 'Super'},
        {id: 2, label: 'Destroyers' , icon: IconDestroyer, title: 'Destoyer'},
        {id: 3, label: 'Cruisers',    icon: IconCruiser, title: 'Cruiser' }, 
        {id: 4, label: 'Battleships', icon: IconBattleship, title: 'Battleship' },
        {id: 5, label: 'Submarines',  icon: IconSubmarine, title: 'Sub Marine'},
        {id: 6, label: 'AirCarriers', icon: IconAircraft_carrier, title: 'Carrier'},
    ];
