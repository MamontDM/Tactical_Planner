    ...
    return ( 
            <div className="planner-wrapper">
                <div className="planner-sidebar">
                    ...
                    <button className="addCondition" onClick={addLimitation}>Add condition</button>
                    ...
                    <button className="planner-sidebar-completeButton" onClick={() => setIsComplete(true)}>Complete</button>
                        </>
                    ) : ( 
